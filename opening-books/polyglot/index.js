...
const RandomCastle = Random64.slice(768, 768+4);
const RandomEnPassant = Random64.slice(764, 764+4);
const RandomTurn = Random64.slice(780, 780+1);
const PromotionPieces = " nbrq".split("");
function encode_move(algebraic_move) {
...
function decode_move(move) {
  ...
  */
  ...
  if (fromFile) {
    moveStr[0] = files.split("")[fromFile];
  } else {
    moveStr[0] = 'a';
  }
    moveStr[1] = fromRow || '1';
  if (toFile) {
    moveStr[2] = files.split("")[toFile]
  } else {
    moveStr[2] = 'a';
  }
  moveStr[3] = toRow || '1';
